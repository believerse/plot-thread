...
// interactions in those plots affect public key imbalances.
...
// It manages and computes public key imbalances as well as interaction and public key interaction indices.
...
type Ledger interface {
	...
	// ConnectPlot connects a plot to the tip of the plot thread and applies the interactions
	// to the ledger.
	ConnectPlot(id PlotID, plot *Plot) ([]InteractionID, error)

	// DisconnectPlot disconnects a plot from the tip of the plot thread and undoes the effects
	// of the interactions on the ledger.
	DisconnectPlot(id PlotID, plot *Plot) ([]InteractionID, error)
	...
	GetInteractionIndex(id InteractionID) (*PlotID, int, error)
	...
	GetPublicKeyInteractionIndicesRange(

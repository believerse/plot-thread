...
The keyholder component is the user facing component for account management. It's responsible for private key management and user-driven network interactions (such as viewing imbalance or sending/receiving interactions).
...
Scribers running in the client are responsible for scribing new plots in coordination with the network. When a scriber running on your local node scribes a new plot it will automatically create an interaction on the network sending the plot reward to one of your keyholder-managed public keys. 
## Pre-requisites
...
$ go get -v github.com/believerse/plot-thread/client github.com/believerse/plot-thread/keyholder
$ go install -v github.com/believerse/plot-thread/client github.com/believerse/plot-thread/keyholder
```
...
These keys will later be used to send and receive interactions on the network from scriber instances or other keyholders.
...
The keyholder will also watch for and notify you about new interaction confirmations to any of your configured public key addresses.

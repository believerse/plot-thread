...
$ go get -v github.com/believerse/plot-thread/client
$ go install -v github.com/believerse/plot-thread/client
```
...
Usage of /home/plotthread/go/bin/client:
  ...
  -prune
        Prune interaction and public key interaction indices
  -pubkey string
...
The client supports two modes of plot reward interactions for scribing: single key and key list targets.

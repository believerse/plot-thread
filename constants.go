...
const PLOTROOT_MATURITY = 1 // plots

const INITIAL_TARGET = "0000000ffff00000000000000000000000000000000000000000000000000000"
...
const INITIAL_MAX_INTERACTIONS_PER_PLOT = 10000 // 16.666... tx/sec, ~4 MBish in JSON

const PLOTS_UNTIL_INTERACTIONS_PER_PLOT_DOUBLING = 105000 // 2 years in plots

const MAX_INTERACTIONS_PER_PLOT = 1<<31 - 1

const MAX_INTERACTIONS_PER_PLOT_EXCEEDED_AT_HEIGHT = 1852032 // pre-calculated
...
const MAX_INTERACTIONS_TO_INCLUDE_PER_PLOT = INITIAL_MAX_INTERACTIONS_PER_PLOT

const MAX_INTERACTION_QUEUE_LENGTH = MAX_INTERACTIONS_TO_INCLUDE_PER_PLOT * 10

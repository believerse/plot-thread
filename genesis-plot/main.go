...
// >> go build
// >> $HOME/harvest-dev/plot-thread/genesis-plot/genesis-plot -pubkey /harvest00000000000000000000000000000000000= -memo "The harvest is plenty, but the workers few."

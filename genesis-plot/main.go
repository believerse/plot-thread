...
// >> go build
// >> $HOME/harvest-dev/plot-thread/genesis-plot/genesis-plot -pubkey ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ= -memo "In the beginning was the plot..."

// Generate a genesis plot
func main() {
	...
	// create the plotroot
	tx := NewInteraction(rootKey, pubKey, 0, 0, 0, *memoPtr)
	...
	plot, err := NewPlot(PlotID{}, 0, target, PlotID{}, []*Interaction{tx})
	if err != nil {
		log.Fatal(err)
	}
